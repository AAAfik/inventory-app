...
INSERT INTO public.pool_chemicals (code, name, unit, dosage_per_m3, purpose, unit_cost, min_stock_alert) VALUES
  ...
  ('PH-DOWN',  'pH minus (bisulfate)',     'g',   15,    'ph_down',    0.006, 3000),
  ('PH-UP',    'pH plus (carbonate)',      'g',   15,    'ph_up',      0.005, 3000),
  ('ALG',      'Algaecide concentrate',    'ml',  3,     'algaecide',  0.015, 2000),
