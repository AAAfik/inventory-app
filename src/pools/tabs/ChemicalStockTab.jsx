    ...
    <div>
      ...
      {editing && (
        <div style={{background:TH.bgCard, border:`2px solid ${TH.accentBorder}`, borderRadius:14, padding:18, marginBottom:16, boxShadow: TH.cardGlow}}>
          <div style={{fontSize:15, fontWeight:800, color:TH.text, marginBottom:12, fontFamily:"'Playfair Display', Georgia, serif"}}>✏️ Edit: {editing.name}</div>
      ...
      {loading ? (
        ...
        <div style={{padding:40, background:TH.bgCard, border:`1px dashed ${TH.border}`, borderRadius:12, color:TH.textMuted, textAlign:"center"}}>
          No chemicals configured. Run the SQL migration to seed defaults.
        </div>
      ) : (
            ...
            return (
              <div key={chem.id} style={{
                ...
                <div style={{display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:12, flexWrap:"wrap", marginBottom:12}}>
                  <div style={{flex:1, minWidth:200}}>
                    <div style={{display:"flex", alignItems:"center", gap:8, marginBottom:4, flexWrap:"wrap"}}>
                      <span style={{fontSize:22}}>{purp.icon}</span>
                ...
                {chem.item_id ? (
                          ...
                          return (
                            <tr key={w.id} style={{borderBottom:`1px solid ${TH.border}`}}>
                              ...
                              <td style={{...td(TH), textAlign:"right", fontSize:11}}>
                                {qty === 0 ? <span style={{color:"#8f8f8f", fontWeight:800}}>OUT</span>
                                  : whLow ? <span style={{color:"#C9A960", fontWeight:800}}>LOW</span>
                  ...
                  <div style={{padding:12, fontSize:11, color:TH.textDim, textAlign:"center", fontStyle:"italic", background:TH.bgInput, borderRadius:8}}>
                    ⚠ Not linked to any warehouse item — chemical use won't auto-deduct.
