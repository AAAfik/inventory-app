    ...
    <div>
            ...
            {!editMode ? (
              <>
                ...
                <div style={{display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(120px, 1fr))", gap:12}}>
                  ...
                  <Info TH={TH} label="Volume"><strong style={{fontFamily:"monospace"}}>{Number(pool.volume_m3).toLocaleString()} m³</strong></Info>
      ...
      {!editMode && (
        <div style={{background:TH.bgCard, border:`1px solid ${TH.border}`, borderRadius:14, padding:18, marginBottom:14, boxShadow: TH.cardGlow}}>
          ...
          <div style={{fontSize:12, color:TH.textMuted, marginBottom:14}}>
            Based on this pool's volume ({Number(pool.volume_m3).toLocaleString()} m³) and standard chemical concentrations. Adjust for actual water readings.
          </div>
            ...
            <table style={{width:"100%", borderCollapse:"collapse", fontSize:13}}>
              ...
              <tfoot>
                <tr style={{background:TH.bgInput}}>
                  ...
                  <td style={{...td(TH), textAlign:"right", fontWeight:800, color:TH.accent, fontFamily:"monospace", fontSize:14}}>
                    {fmtMoney(totalTreatmentCost)}
                  </td>
                </tr>
              </tfoot>
            </table>
      ...
      {!editMode && (
        <div style={{background:TH.bgCard, border:`1px solid ${TH.border}`, borderRadius:14, padding:18, boxShadow: TH.cardGlow}}>
          <div style={{fontSize:14, fontWeight:800, color:TH.text, marginBottom:12, fontFamily:"'Playfair Display', Georgia, serif"}}>📋 Recent treatments</div>
          {history.length === 0 ? (
