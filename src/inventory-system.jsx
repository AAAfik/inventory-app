...
const TAB_ICONS = {reports:"\ud83d\udccb",dashboard:"\u25c8",itemsMgmt:"\u229e",inventory:"\u25a6",purchases:"\u2193",consumption:"\u2197",returns:"\u21a9",orders:"\u25ce",suppliers:"\u22a1",activityLog:"\ud83d\udccb",caesarMap:"\ud83d\uddfa",pools:"\ud83c\udfca"};
...
export default function App() {
  ...
  const allTabs = isAdmin ? ["dashboard","itemsMgmt","inventory","purchases","consumption","returns","orders","caesarMap","syncMaps",...(POOLS_ENABLED?["pools"]:[]),"reports","suppliers","activityLog"] : ["consumption"];
