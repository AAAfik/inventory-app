...
const TAB_ICONS = {reports:"\ud83d\udccb",dashboard:"\u25c8",itemsMgmt:"\u229e",inventory:"\u25a6",purchases:"\u2193",consumption:"\u2197",returns:"\u21a9",orders:"\u25ce",suppliers:"\u22a1",activityLog:"\ud83d\udccb",caesarMap:"\ud83d\uddfa",pools:"\ud83c\udfca",procure:"\ud83d\udcb3",warehouse:"\ud83c\udfec",inspection:"\ud83d\udd0d"};
...
export default function App() {
  ...
  const allTabs = ["dashboard",...(WAREHOUSE_ENABLED?["warehouse"]:[]),...(INSPECTION_ENABLED?["inspection"]:[]),...(PROCURE_ENABLED?["procure"]:[])];
    ...
    <div dir={lang==="fa"||lang==="he"?"rtl":"ltr"} style={{display:"flex",flexDirection:"column",minHeight:"100vh",background:TH.bg,color:TH.text,fontFamily:lang==="fa"?"'Vazirmatn','Tahoma',sans-serif":lang==="he"?"'Heebo','Arial',sans-serif":"'Inter','Segoe UI',system-ui,sans-serif"}}>
      ...
      <div style={{display:"flex",flex:1,minHeight:0,position:"relative"}}>
        ...
        <main style={{flex:1,padding:isMobile?"16px 14px":"24px 28px",overflowY:"auto",overflowX:"hidden",minWidth:0,width:"100%"}}>
          ...
          {WAREHOUSE_ENABLED&&tab==="warehouse"&&<WarehouseHub TH={TH} lang={lang} isMobile={isMobile} isAdmin={isAdmin} />}

          {INSPECTION_ENABLED&&tab==="inspection"&&<InspectionHub TH={TH} lang={lang} isMobile={isMobile} isAdmin={isAdmin} />}
