        ...
        <div style={{display:"flex", gap:16, flexWrap:"wrap"}}>
          ...
          <div style={{flex:1, minWidth:220}}>
            ...
            <div style={{display:"grid", gridTemplateColumns:isMobile?"1fr 1fr":"repeat(3, 1fr)", gap:10}}>
              <Info TH={TH} label={L.kind}><Icon name={kindMeta.icon} size={15} /> {kindMeta.label}</Info>
              ...
              return (
                <div key={m.id} style={{display:"flex", gap:12, paddingBottom: i < movements.length-1 ? 14 : 0, position:"relative"}}>
                  <div style={{display:"flex", flexDirection:"column", alignItems:"center", flexShrink:0}}>
                    <div style={{width:30, height:30, borderRadius:15, background:TH.bgInput, display:"flex", alignItems:"center", justifyContent:"center", fontSize:13, zIndex:1}}><Icon name={meta.icon} size={15} /></div>
