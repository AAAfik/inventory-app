    ...
    <div>
      ...
      <div style={{background:TH.bgCard, border:`1px solid ${TH.border}`, borderRadius:12, borderLeft:`4px solid ${sm.color}`, padding:20, marginBottom:16}}>
        <div style={{display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:12, flexWrap:"wrap", marginBottom:14}}>
          <div>
            <div style={{fontSize:11, color:sm.color, fontWeight:700, textTransform:"uppercase", letterSpacing:"0.5px", marginBottom:4}}><Icon name={sm.icon} size={15} /> {sm.label}</div>
            ...
            {history.map((h) => {
              ...
              return (
                <div key={h.id} style={{position:"relative", marginBottom:10, paddingLeft:20}}>
                  <div style={{position:"absolute", left:-16, top:6, width:16, height:16, background:em.color, borderRadius:8, display:"flex", alignItems:"center", justifyContent:"center", fontSize:9}}><Icon name={em.icon} size={15} /></div>
