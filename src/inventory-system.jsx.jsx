        ...
        <main style={{flex:1,padding:isMobile?"16px 14px":"24px 28px",overflowY:"auto",overflowX:"hidden",minWidth:0,width:"100%"}}>
          ...
          {tab==="caesarMap"&&isAdmin&&<>
            ...
            <div style={{...card,padding:40,textAlign:"center"}}>
              <div style={{width:"100%",maxWidth:520,margin:"0 auto",aspectRatio:"16/9",borderRadius:14,background:"url('/resort-aerial.jpg') center/cover, #1a2035",backgroundSize:"cover",backgroundPosition:"center",position:"relative",marginBottom:24,overflow:"hidden",border:`1px solid ${TH.border}`}}>
                <div style={{position:"absolute",inset:0,background:"linear-gradient(180deg,rgba(0,0,0,.2),rgba(0,0,0,.6))",display:"flex",alignItems:"center",justifyContent:"center"}}>
                  <div style={{fontSize:64,filter:"drop-shadow(0 4px 12px rgba(0,0,0,.5))"}}>{"\ud83d\uddfa\ufe0f"}</div>
                </div>
              </div>
              ...
              <div style={{color:TH.textMuted,fontSize:13,marginBottom:24,maxWidth:480,margin:"0 auto 24px"}}>
                Interactive map editor with drag-and-drop pins, layers, categories, and Save/Load.
              </div>
              <div style={{display:"flex",gap:10,justifyContent:"center",flexWrap:"wrap"}}>
                <a href="/caesar-map-editor.html" style={{background:"linear-gradient(135deg,#6366f1,#8b5cf6)",border:"none",borderRadius:10,padding:"14px 28px",color:"#fff",fontSize:14,fontWeight:700,cursor:"pointer",fontFamily:"inherit",boxShadow:"0 6px 16px rgba(99,102,241,.35)",textDecoration:"none",display:"inline-block"}}>
                  {"\ud83d\ude80 Launch Map Editor"}
                </a>
                <a href="/caesar-map-editor.html" target="_blank" rel="noopener" style={{background:TH.bgInput,border:`1px solid ${TH.borderStrong}`,borderRadius:10,padding:"14px 24px",color:TH.text,fontSize:13,fontWeight:600,cursor:"pointer",fontFamily:"inherit",textDecoration:"none",display:"inline-block"}}>
                  {"\u2197 Open in new tab"}
                </a>
              </div>
